...
namespace EntityFrameworkPerformanceTests.DatabaseFirst
{
    ...
    public partial class DatabaseFirstDataContext : DbContext
    {
        public DatabaseFirstDataContext()
            : base("name=DatabaseFirstDataContext")
        {
        }
        ...
        [DbFunction("DatabaseFirstDataContext", "ufnGetContactInformation")]
        public virtual IQueryable<ufnGetContactInformation_Result> ufnGetContactInformation(Nullable<int> personID)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<ufnGetContactInformation_Result>("[DatabaseFirstDataContext].[ufnGetContactInformation](@PersonID)", personIDParameter);
        }
